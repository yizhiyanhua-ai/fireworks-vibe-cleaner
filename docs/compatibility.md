...
| Codex cleanup | Old `.log` files below `log/` or `logs/` only |
...
| Jev | Opt-in TypeSafe HTTP adapter; mocked contract tests do not establish live availability or accuracy |
