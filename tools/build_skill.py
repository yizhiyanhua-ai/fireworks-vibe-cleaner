...
FILES = ["SKILL.md", "README.md", "README.zh.md", "LICENSE", "CHANGELOG.md", "SECURITY.md", "CONTRIBUTING.md",
         ...
         "tools/live_jev_validation.py", "tools/live_triage_validation.py", "tools/live_evidence_validation.py", "tools/live_purpose_validation.py", "tools/native_history_validation.py"]
